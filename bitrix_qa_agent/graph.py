...
builder.add_node(NodeNames.vector_search_articles, vector_search_articles)
...
builder.add_edge(NodeNames.identify_search_query, NodeNames.vector_search_articles)
builder.add_edge(NodeNames.vector_search_articles, NodeNames.get_relevant_articles_ids)
